...
- Template/content generators.
  ...
  - `getDataWithTimeCountCombineProgram`/`getDataWithScoreBoardCombineProgram` and the remaining literal digit-bitmap override tables for the clock/date builders still need APK source/golden-vector confirmation before being marked exact.
